...
const HighschoolProfessorReportsTableHeader = ({
    ...
    return (
        ...
        <tr className={"table-header"}>
            ...
            <th className={"table-header-cell th-dimension"}>Class Name</th>
            <th className={"table-header-cell th-dimension"}>Teaching Project</th>
            <th className={"table-header-cell th-dimension"}>SID</th>
...
export default HighschoolProfessorReportsTableHeader;